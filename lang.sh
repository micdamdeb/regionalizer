...
xgettext-- keyword = _-- language = C-- add - comments-- sort - output - o po / regionalizer.pot main.cpp msgmerge-- update po / pl / regionalizer.po po / regionalizer.pot msgfmt-- output - file = po / pl / regionalizer.mo po / pl / regionalizer.po
